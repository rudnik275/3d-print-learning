...
- `tools/UIDrive.app` — клики/клавиши в Studio (`open -W -a tools/UIDrive.app --args click X Y | key 36 | type …`; координаты в поинтах экрана, брать со скриншота ÷2 на Retina); нужно «Универсальный доступ» для UIDrive. Кадр с камеры принтера — `tools/bbl_printer.py camera out.jpg`.
