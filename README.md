...
1. `lessons/01-walls-calibration.md` — горбы на стенках коробки: состав стола, переходы геометрии, шов. Коробка закрыта 17.09 на пакете скилла (): остаток — кромки окна, лечит фаска в дизайне; тест 1 (scarf seam) ждёт.
