...
that we no longer have; the meshes are re-generated from the sources, re-centred with the recorded
source_offset_* so the saved item transforms still apply.
